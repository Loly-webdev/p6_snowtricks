...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $trick1
            ->setName("Mute")
            ->setDescription(
                "La figure Mute n'est jamais une astuce, mais cela vaut vraiment la peine d'essayer car elle corrigera les problèmes de posture mineurs qui découlent d'une conduite légèrement ouverte, améliorant ainsi votre positionnement global de style libre. Une saisie silencieuse est l'endroit où la main avant saisit le bord de l'orteil entre les pieds. La planche est maintenue à plat.
        ...
        $trick5
            ->setName("Backflip")
            ->setDescription(
                "Le fameux Backflip, un trick très fun et facile à maitriser que l’on peut placer à beaucoup d’endroits.
